...
export default async function HistoricoOficialPage() {
  const history = await getDailyHistory('OFICIAL', 365);
      ...
      <section className="grid gap-6">
        <div className="grid gap-3">
          ...
          <p className="text-ink/70 max-w-2xl">
            Serie histórica con promedios diarios del dólar oficial. Datos agregados de fuentes
            institucionales y validados.
          </p>
        </div>
